...
var animateid, renderer, stats, scene, camera;
...
export default {
  ...
  mounted() {
    ...
    let startdemo = new Start('diudiudiu');

    console.log(startdemo)

    return;

    console.log('hhh, mounted');
    ...
    function init() {
      ...
      // camera = new THREE.PerspectiveCamera(75, container.clientWidth / container.clientHeight, 0.1, C_ROOM_WIDTH * 10);
